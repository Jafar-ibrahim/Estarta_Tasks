...
import com.example.twitterApi.Service.TokenInfoService;
...
public class AuthService {	
	 ...
	 public JWTResponseDto login(String login, String password) {
	        ...
	        TwitterUserDetail userDetails = (TwitterUserDetail) authentication.getPrincipal();
	 ...
	 public TokenInfo createLoginToken(String userName, Long userId) {
			...
			tokenInfo.setUser(new TwitterUser(userId));
